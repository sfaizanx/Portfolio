    ...
    setProjects([
      {
        ...
        description: "Full-stack e-commerce app with React and .NET Core backend.",
      ...
      },
      {
        ...
        description: "Personal responsive portfolio built with React and Tailwind.",
    ...
    <div className={`${darkMode ? "dark" : ""} transition-colors duration-700`}>
      <div className="min-h-screen bg-gradient-to-tr from-gray-100 via-gray-200 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-800 dark:text-gray-100 px-6 py-10">
        ...
        Hi, I'm FAIZAN SAYYED
          ...
          <p className="text-xl md:text-2xl font-light">Full-Stack Developer | React | .NET Core | Tailwind | Sql</p>
          <a href="mailto:sayyedfaizan1777@gmail.com" className="mt-6 inline-block">
            <Button variant="outlined" className="mt-5">Hire Me</Button>
          </a>
        </motion.section>
        ...
        >
          ...
          <p className="text-lg text-justify">
            I'm a freelance web developer who loves to design and build clean, responsive, and scalable web applications. Passionate about solving problems and constantly improving user experiences with modern tools like React, Tailwind, and .NET Core.
          </p>
        </motion.section>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {["HTML", "CSS", "JavaScript", "React", ".NET Core", "SQL", "Tailwind CSS", "Git", ".NET API", "NodeJS", "MongoDB","C/C++"].map(skill => (
              <motion.div
                key={skill}
            ...
            {projects.map(project => (
              ...
              >
                ...
                <div className="flex justify-between">
                  <a href={project.liveUrl} className="text-indigo-600 hover:underline" target="_blank" rel="noreferrer">Live Demo</a>
                  <a href={project.githubUrl} className="text-indigo-600 hover:underline" target="_blank" rel="noreferrer">GitHub</a>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        >
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
              <p className="italic">“Incredible developer! Delivered the project on time and exceeded expectations.”</p>
              <p className="text-right text-sm mt-2 font-light">— Ansari Saud</p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
              <p className="italic">“Great communication and quality work. Highly recommended!”</p>
              <p className="text-right text-sm mt-2 font-light">— Shahad Mulla</p>
            </div>
          </div>
        </motion.section>
